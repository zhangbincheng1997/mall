...
public class BuyerOrderController {
    ...
    public Result get(Principal principal, @PathVariable("id") Long id) {
    ...
    @ResponseBody
    @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_USER')")
    public PageResult list(Principal principal, @Valid PageRequest pageRequest) {
        PageResult pageResult = orderService.listByBuyer(principal.getName(), pageRequest);
        return pageResult;
    }
    ...
    @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_USER')")
    public Result buy(Principal principal, @Valid @RequestBody OrderMasterDto orderMasterDto) {
